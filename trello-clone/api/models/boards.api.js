class BoardApi {
  ...
  getAllForDomain = async domainId => {
    return this._baseApi.findAll(this._collectionRef, 'domainId', domainId);
  };

  getAllStarred = async () => {
    return this._baseApi.findAll(this._collectionRef, 'isStarred', true);
  };
